...
namespace ExpressVoitures.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!is2faTokenValid)
            {
                ModelState.AddModelError("Input.Code", "Le code de vérification n’est pas valide.");
                await LoadSharedKeyAndQrCodeUriAsync(user);
                return Page();
            }
            ...
            _logger.LogInformation("Utilisateur avec ID '{UserId}' a activé l’authentification à 2FA avec une application d’authentification.", userId);
